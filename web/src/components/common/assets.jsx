    ...
    return (
      <div style={{ display: "inline-block", width: width, height: height }}>
        <svg preserveAspectRatio="none" viewBox="0 0 1328.4 1074.89">
          <path d="M472.59,189.18" transform="translate(-55.31 -149.32)" style={{
            fill: 'none', stroke: '#f79f8b', strokeMiterlimit: 10, strokeWidth: '35px'
          }} />
          <path d="M535.49,470.29" transform="translate(-55.31 -149.32)" style={{
            fill: 'none', stroke: '#f79f8b', strokeMiterlimit: 10, strokeWidth: '35px'
          }} />
          ...
          <path d="M720.49,649" transform="translate(-55.31 -149.32)" style={{fill:'none',stroke:'#f79f8b',strokeMiterlimit:10,strokeWidth:'35px'}}/>
          <path d="M551.91,449.84" transform="translate(-55.31 -149.32)" style={{fill:'none',stroke:'#f79f8b',strokeMiterlimit:10,strokeWidth:'35px'}}/>
          <path d="M1083.51,893.8l.2-108.74-255,145.2-.63-780.94L720.49,211.2,327.32,422V876L720.5,1102.69h0M439.33,811.36V486.7L720.49,324.38V973.69Z" transform="translate(-55.31 -149.32)" 
            style={{fill:'#f79f8b'}}/>
